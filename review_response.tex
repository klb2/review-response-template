\documentclass[12pt,english,DIV=13,revnumtocomment,revnumtoheader]{reviewresponse}
...
\begin{revcomment}
	The editor might also have some individual comments that need to be numbered.
\end{revcomment}
...
\begin{revresponse}
	...
	(Note that the printed number automatically changes if the \texttt{revnumtocomment} class option is enabled.)
	When referring to specific comments made by the editor, the reviewer number \verb|<rev_num>| is zero, e.g., \autoref{comment:0.1}.
